...
<?php if ((isset($_SESSION["username"]) || isCookieValid($db))) : ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 sidebar fixed-top">
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <!-- sidebar menu item -->
                            <li class="nav-item">
                                <a href="dashboard.php" class="nav-link text-white p-3 mb-2 sidebar-link small-text"><i class="fas fa-chart-bar text-light fa-lg mr-3"></i>Energy Trends Dashboard</a>
                            </li>
                            <!-- end sidebar menu item -->

                            <!-- sidebar menu item -->
                            <li class="nav-item">
                                <a href="dashboard2.php" class="nav-link text-white p-3 mb-2 current small-text"><i class="fas fa-tachometer-alt text-light fa-lg mr-3"></i>Feeder performance Dashboard</a>
                            </li>
                            <!-- end sidebar menu item -->
                            <!-- sidebar menu item -->
                            <li class="nav-item">
    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-9 ml-auto pt-5 mt-3 mb-5 pl-5 embed-responsive embed-responsive-16by9">
                    <iframe width="1140" height="600" class="embed-responsive-item pt-5" src="https://app.powerbi.com/view?r=eyJrIjoiNWZlZTk5NjctYmI1ZC00YmMwLTlkMGYtNzkzZGFhMjE4YTI1IiwidCI6IjUzMjc2MWM4LTYzZDYtNDk5OC1hNTIwLTNmZDYxOGVkNzM0MCIsImMiOjh9" frameborder="0" allowFullScreen="true"></iframe>
                </div>
            </div>
        </div>
    </section>
