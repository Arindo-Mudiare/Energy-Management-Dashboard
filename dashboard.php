...
<?php if ((isset($_SESSION["username"]) || isCookieValid($db))) : ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 sidebar fixed-top">
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <!-- sidebar menu item -->
                            <li class="nav-item">
                                <a href="dashboard.php" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-chart-bar text-light fa-lg mr-3"></i>Energy Trends Dashboard</a>
                            </li>
                            <!-- sidebar menu item -->
                            <!-- sidebar menu item -->
                            <li class="nav-item">
    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-10 ml-auto pt-5 mt-3 mb-5 pl-5">
                    <iframe width="1140" height="600" class="embed-responsive-item" src="https://app.powerbi.com/reportEmbed?reportId=7fb59bc8-3628-4614-ae5d-d92416cf6821&autoAuth=true&ctid=a1f28b7e-540c-4df2-b423-54c0620fd5c9&config=eyJjbHVzdGVyVXJsIjoiaHR0cHM6Ly93YWJpLXNvdXRoLWFmcmljYS1ub3J0aC1hLXByaW1hcnktcmVkaXJlY3QuYW5hbHlzaXMud2luZG93cy5uZXQvIn0%3D" frameborder="0" allowFullScreen="true"></iframe>
                </div>
            </div>
        </div>
    </section>
