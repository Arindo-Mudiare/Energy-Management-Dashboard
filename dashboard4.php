                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 sidebar fixed-top">
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <!-- sidebar menu item -->
                            <li class="nav-item">
                                <a href="dashboard4.php" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-chart-line text-light fa-lg mr-3"></i>Daily performance Dashboard</a>
                            </li>
                            <!-- sidebar menu item -->
                            <!-- sidebar menu item -->
                            <li class="nav-item">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-9 ml-auto pt-5 mt-3 mb-5 pl-5">
                    <h1 class="display-2 text-info">Dashboard 4</h1>
                </div>
            </div>
        </div>
    </section>
